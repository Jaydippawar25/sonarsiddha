...
const Home = ({ language }) => {
  ...
  return (
    <div className="w-full bg-slate-50 text-slate-900 font-body">
      ...
      {/* Modern Agri-Tech Stat Strip (Fresh Light Green BG with Animated Border Cards) */}
      <section className="bg-[#E6F4EA] border-y-2 border-emerald-300/80 py-10 sm:py-12 relative overflow-hidden shadow-xs">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-6 text-center">
            <ScrollReveal delay={0}>
              <div className="bg-white text-slate-900 animated-border-box hover:bg-emerald-50 border border-emerald-300/70 p-4 sm:p-6 rounded-2xl transition-all shadow-md flex flex-col justify-center h-full group">
            ...
            <ScrollReveal delay={300}>
              <div className="bg-white text-slate-900 animated-border-box hover:bg-amber-50 border border-amber-300/70 p-4 sm:p-6 rounded-2xl transition-all shadow-md flex flex-col justify-center h-full group">
