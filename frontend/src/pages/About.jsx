        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 relative">
            <ScrollReveal delay={100}>
              ...
              <div className="relative border-4 border-[#2F5233]/25 p-3.5 bg-white rounded-[2.5rem] shadow-xl hover-lift">
                
                {/* Inner Image Container with Matching Curves */}
                <div className="relative h-[380px] md:h-[460px] overflow-hidden rounded-2xl bg-[#1C2A1E]/5 group">
                  <img 
                    src={image1} 
                  ...
                  <div className="absolute top-4 left-4 bg-[#1C2A1E]/90 backdrop-blur-md text-[#F3EEE1] px-3.5 py-1.5 rounded-full border border-[#B8862E]/50 flex items-center gap-2 shadow-lg animate-pulse-glow">
